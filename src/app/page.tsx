        ...
        <div className='px-8 lg:px-16 py-16 lg:py-32 bg-white'>
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 max-w-6xl mx-auto'>
            <div className="prose lg:prose-lg prose-headings:font-semibold max-w-3xl">
              ...
              <p><strong>That drive to learn and make better things has stayed with me throughout my career.</strong> I&rsquo;ve built websites for universities, helped grow design teams from the ground up, created design systems used by thousands of sites, and led projects that won Webby Awards. I even host a design podcast and speak at conferences. But underneath it all, I&rsquo;m still just a maker who wants to take a complex mess and turn it into something beautiful, useful, and human.</p>
              <p>37signals/Basecamp is on the short list of companies I&rsquo;ve always admired. </p>
              <p>A decade ago, I landed a job at another one of the companies I admired: Four Kitchens. <strong>I&rsquo;ve had an incredible run there — I rebuilt the creative team, led major design system initiatives, and helped institutions like NYU and Yale make major digital leaps. But after a long and successful chapter, I&rsquo;m ready for something new.</strong> I want to go deep into product work. I want to focus, iterate, and ship alongside people who care deeply about doing the work right. </p>
            ...
            <div className='h-full max-w-xl flex-col items-start justify-start pb-8 hidden lg:flex'>
              <div className='bg-ash-200 pb-16 sticky top-4'>
                ...
                <Carousel className='max-h-[650px] min-h-[650px]'>
        ...
        <div className='px-8 lg:px-16 py-16 lg:py-32 bg-blue-800'>
          <div className='max-w-6xl mx-auto'>
            <div className="prose lg:prose-lg prose-headings:font-semibold prose-invert prose-p:text-white max-w-3xl mx-auto font-medium">
              ...
              <p> I&rsquo;ve used my skills to help universities clarify their missions, nonprofits raise more funds, and even tabletop gaming companies improve their digital experiences. (I&rsquo;m a giant RPG nerd — I&rsquo;ve contributed to sites and games that have won ENNIE awards, the Webby-equivalents of the roleplaying world.) Whether I&rsquo;m helping a friend launch their Kickstarter or working with a university to tell its story online, I bring the same care and curiosity to every project.</p>

              <p><strong>As for why I love the web?</strong></p>
              
              <p>It&rsquo;s alive.</p>
              
              <p>It responds.</p>
              
              <p>It changes based on your preferences, your actions, your device.</p>
              
              <p>That level of interactivity is like nothing else. I love designing for that — for the little animations that make something feel delightful, the responsive moments that surprise and delight, and the thoughtful structures that allow everyone on any device to access the same tools and info. There&rsquo;s something almost magical about how a few lines of code can turn into something millions use daily.</p>

              <p>Working on the web is also inherently inclusive. Anyone with a phone and a connection can access the same world of ideas. That&rsquo;s powerful. And I want to be part of the team making that experience better, faster, and more humane.</p>
            </div>
          </div>
        </div>
