...
projectRole: "Creative Director, Designer, Front-end Developer"
links:
...
<p className="lead">
  **In a pioneering effort to match the ambitious goals of the Wu Tsai Institute
  at Yale, a newly established research hub dedicated to exploring the
  intricacies of the human brain, our task was to create an equally ambitious
  digital presence.** This project culminated in a state-of-the-art website that
  received critical acclaim and earned nominations for two prestigious Webbys:
  Best School/University Site and Best Mobile Visual Design - Aesthetic.
  Competing against heavyweights like Spotify's Wrapped, the recognition
  highlighted our innovative approach and the stunning visual identity we
  crafted for the institute.
</p>
